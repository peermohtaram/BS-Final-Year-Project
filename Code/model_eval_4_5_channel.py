...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(5, 16, 3, padding=1 ,stride=1)
...
def makefeature(image):
    ...
    fd2=resize(fd1,(80,80),mode='constant')
 
    #BOTH LBP AND HOG FEATURES
    lbp=lbp.reshape((80,80,1))
    fd2=fd2.reshape((80,80,1))
 
    #IMAGE CONCATENATION TO MAKE 5 CHANNELS
    newimage=np.concatenate((image,lbp,fd2),2)
